...
export async function generateMetadata({
  ...
  if (resume?.firstName === undefined && resume?.lastName === undefined) {
    return {
      title: "CareerCraftAi - Professional AI Resume Builder",
      description:
  ...
  return {
    ...
    ${resume?.lastName}${resume?.lastName && " "}- CareerCraftAi`,
    description: `${resume?.firstName} ${resume?.lastName}'s Resume. Powered by CareerCraftAi.`,
  };
}
